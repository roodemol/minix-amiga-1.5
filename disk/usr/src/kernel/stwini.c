 ...
 * on the Atari ST.
 * If your drive is an old Supra drive you perhaps want to compile 
 ...
 *
 * This file is also included in the AmigaMINIX distribution as an example
 * to those users who would like to write their own harddisk driver.
 *
